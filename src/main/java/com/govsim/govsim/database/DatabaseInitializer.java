    ...
    private static void createTablesIfNotExist() throws SQLException {
        ...
        try (Connection conn = DriverManager.getConnection(url, USER, PASSWORD);
            ...
            String createCityState = "CREATE TABLE IF NOT EXISTS city_state (" +
                    ...
                    "interior_health INT NOT NULL DEFAULT 100, " +
                    "defense_health INT NOT NULL DEFAULT 100, " +
                    "finance_health INT NOT NULL DEFAULT 100, " +
                    "population_health INT NOT NULL DEFAULT 100, " +
                    "health_health INT NOT NULL DEFAULT 100, " +
